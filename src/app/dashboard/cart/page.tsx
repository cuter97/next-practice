...
export default function CartPage() {
    ...
    const totalToPay = productsInCard.reduce((prev, current) => (current.product.price * current.quantity) + prev, 0)

    return (
        <div>
            <h1 className="text-5xl mt-2">Productos en el carrito</h1>
            <hr className="mb-2" />
